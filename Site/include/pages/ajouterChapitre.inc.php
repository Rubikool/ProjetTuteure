...
<form method="post" action="#">
	<fieldset>
		...
		</br> <label for="descriptionChap">Description du chapitre (max. 255
			caractères) :</label><br />
		<textarea name="descriptionChap" id="description"></textarea>
		<br /> </br> <input type="submit" value="Ajouter" id="Valider" />
...
<div class="piecejointe">
	...
	<p>
		<a href="index.php?page=14" id="lien"><span id="lienNom">Ajouter un
				fichier</span></a>
	</p>
	</p>
</div>
<div class="lien">
	...
	<p>
		<a href="<?php echo $lien;?>" target="_blank">   <?php echo $lien; ?>  </a>
                                    ...
                                    <?php } ?>
                                    <p>
		<a href="index.php?page=15" id="lien"><span id="lienNom">Ajouter un
				lien</span></a>
	</p>
	</p>
</div>
...
<div class="chap">
	...
	<br />
	<p>
		Chapitre : <label for="name"><?php echo $nomChapitre.'<br/>'; ?></label>
	</p>
	<p>
                                      <?php
	...
	<div class="partition">
		...
		?>
                                            <p>
			<a href="index.php?page=16" id="lien"><span id="lienNom">Ajouter une
					Partition</span></a>
		</p>
                                            <?php
		?>
...
<?php
	...
	$chapitre = new Chapitre ( array (
			'cha_num' => $NbrChapitreNum,
