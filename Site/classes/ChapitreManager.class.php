...
class ChapitreManager {
  ...
  public function add($chapitre){
    $req = $this->db->prepare('INSERT INTO chapitre (cha_num, cha_description, cha_nom,
      per_num_valide, met_num) VALUES(:cha_num, :cha_description,
      :cha_nom, :per_num_valide, :met_num)');
  ...
  public function getAllChapitreParMethode($met_num){
    ...
    $sql='SELECT cha_num,cha_description,cha_nom,per_num_valide,chapitre.met_num FROM chapitre
